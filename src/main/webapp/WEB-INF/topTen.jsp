        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Lookify - Top Ten</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container w-50">
                            ...
                            <h3 class="bg-primary text-light ps-3">Top Ten Songs</h3>
                            <p class="w-100"></p>
                            ...
                            <div class="container bg-primary text-dark rounded-3">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <!-- set songCount to 0 -->
                                        <c:set var="songCount" value="${songCount = 0}" />
                                        <c:forEach var="song" items="${songs}">

                                            <!-- only use 10 songs -->
                                            <c:if test="${songCount < 10}">
                                                <tr>
                                                    <td scope="row">
                                                        <p class="text-center">
                                                ...
                                                <!-- increment songCount -->
                                                <c:set var="songCount" value="${songCount = songCount + 1}" />
                                            </c:if>
                                        </c:forEach>
